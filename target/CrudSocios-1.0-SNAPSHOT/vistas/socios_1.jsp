...
<main>
    ...
    <div class="container-fluid" style= "background-color: #2B2929 " width="100" p-2>
<!---- Inicio titulo  -->
     <div class= "text-center text-white " mb-4>
     <p>  <span style="font-size: 40px;font-weight:bold;font-family:'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"> RESULTADO DE LA BUSQUEDA </span></p>
     </div>
 <!---- fin titulo  -->
 ...
 <!---- Inicio tabla  -->
             <div class="row p-4">   
                 <table class="table table-secondary" >
                    ...
                    resultado=s1.buscarSocio(apellido);
